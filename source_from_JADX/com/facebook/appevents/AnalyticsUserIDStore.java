...
class AnalyticsUserIDStore {
    ...
    final class C01991 implements Runnable {
        C01991() {
        }
    ...
    final class C02002 implements Runnable {
    ...
    public static void initStore() {
        if (!initialized) {
            AppEventsLogger.getAnalyticsExecutor().execute(new C01991());
        }
    }
    ...
    public static void setUserID(String str) {
        ...
        AppEventsLogger.getAnalyticsExecutor().execute(new C02002(str));
    }
}
