...
public class LikeActionController {
    ...
    final class C03175 extends AccessTokenTracker {
        ...
        protected final void onCurrentAccessTokenChanged(AccessToken accessToken, AccessToken accessToken2) {
            ...
            LikeActionController.broadcastAction(null, LikeActionController.ACTION_LIKE_ACTION_CONTROLLER_DID_RESET, null);
        }
    }
    ...
    private void presentLikeDialog(Activity activity, FragmentWrapper fragmentWrapper, Bundle bundle) {
        ...
        if (LikeDialog.canShowNativeDialog()) {
            ...
            broadcastAction(null, ACTION_LIKE_ACTION_CONTROLLER_UPDATED, null);
            str = null;
        }
        if (str != null) {
...
*/
    ...
    private void updateState(boolean z, String str, String str2, String str3, String str4, String str5) {
        ...
        if (obj != null) {
            ...
            serializeToDiskAsync(this);
            broadcastAction(this, ACTION_LIKE_ACTION_CONTROLLER_UPDATED, null);
        }
    }
