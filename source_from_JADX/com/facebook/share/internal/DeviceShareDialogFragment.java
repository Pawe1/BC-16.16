...
public class DeviceShareDialogFragment extends C0074q {
    ...
    class C03102 implements Callback {
        C03102() {
        }
    ...
    private static class RequestState implements Parcelable {
        public static final Creator<RequestState> CREATOR = new C03121();
        private long expiresIn;
        private String userCode;

        final class C03121 implements Creator<RequestState> {
            C03121() {
            }
    ...
    private void detach() {
        if (isAdded()) {
            getFragmentManager().mo24a().mo54a(this).mo52a();
        }
    }
    ...
    private void setCurrentRequestState(RequestState requestState) {
        ...
        this.codeExpiredFuture = getBackgroundExecutor().schedule(new C03113(), requestState.getExpiresIn(), TimeUnit.SECONDS);
    }
    ...
    private void startShare() {
        ...
        new GraphRequest(null, DEVICE_SHARE_ENDPOINT, graphParametersForShareContent, HttpMethod.POST, new C03102()).executeAsync();
    }

    public Dialog onCreateDialog(Bundle bundle) {
        this.dialog = new Dialog(getActivity(), C0196R.style.com_facebook_auth_dialog);
        View inflate = getActivity().getLayoutInflater().inflate(C0196R.layout.com_facebook_device_auth_dialog_fragment, null);
        ...
        ((Button) inflate.findViewById(C0196R.id.cancel_button)).setOnClickListener(new C03091());
