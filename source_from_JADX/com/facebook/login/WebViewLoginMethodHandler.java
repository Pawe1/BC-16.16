...
class WebViewLoginMethodHandler extends WebLoginMethodHandler {
    public static final Creator<WebViewLoginMethodHandler> CREATOR = new C02872();
    private String e2e;
    private WebDialog loginDialog;

    final class C02872 implements Creator {
        C02872() {
        }
    ...
    boolean tryAuthorize(final Request request) {
        ...
        OnCompleteListener c02861 = new OnCompleteListener() {
        ...
        this.loginDialog = new AuthDialogBuilder(activity, request.getApplicationId(), parameters).setE2E(this.e2e).setIsRerequest(request.isRerequest()).setOnCompleteListener(c02861).build();
