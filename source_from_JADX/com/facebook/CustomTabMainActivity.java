...
public class CustomTabMainActivity extends Activity {
    ...
    private void sendResult(int i, Intent intent) {
        ax.m123a((Context) this).m125a(this.redirectReceiver);
        if (intent != null) {
            setResult(i, intent);
        } else {
            setResult(i);
    ...
    protected void onCreate(Bundle bundle) {
        ...
        if (CustomTabActivity.CUSTOM_TAB_REDIRECT_ACTION.equals(getIntent().getAction())) {
            ...
            this.redirectReceiver = new C01771();
            ax.m123a((Context) this).m126a(this.redirectReceiver, new IntentFilter(CustomTabActivity.CUSTOM_TAB_REDIRECT_ACTION));
        }
    }
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (REFRESH_ACTION.equals(intent.getAction())) {
            ax.m123a((Context) this).m127a(new Intent(CustomTabActivity.DESTROY_ACTION));
            sendResult(-1, intent);
