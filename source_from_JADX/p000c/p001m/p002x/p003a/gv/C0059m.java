...
public class C0059m extends C0058n implements OnCancelListener, OnDismissListener {
    ...
    void dismissInternal(boolean z) {
        if (!this.mDismissed) {
            ...
            if (this.mBackStackId >= 0) {
                getFragmentManager().mo60a(this.mBackStackId);
                this.mBackStackId = -1;
                return;
            }
            ag a = getFragmentManager().mo58a();
            a.mo25a(this);
            if (z) {
                a.mo27b();
            } else {
    ...
    public LayoutInflater getLayoutInflater(Bundle bundle) {
        ...
        if (this.mDialog == null) {
            return (LayoutInflater) this.mHost.f252b.getSystemService("layout_inflater");
        }
    ...
    public int show(ag agVar, String str) {
        ...
        agVar.mo26a(this, str);
        this.mViewDestroyed = false;
        this.mBackStackId = agVar.mo23a();
        return this.mBackStackId;
    }

    public void show(C0071v c0071v, String str) {
        this.mDismissed = false;
        this.mShownByMe = true;
        ag a = c0071v.mo58a();
        a.mo26a(this, str);
