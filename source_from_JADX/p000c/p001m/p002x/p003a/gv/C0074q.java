...
public class C0074q extends C0073r implements OnCancelListener, OnDismissListener {
    ...
    void dismissInternal(boolean z) {
        if (!this.mDismissed) {
            ...
            if (this.mBackStackId >= 0) {
                getFragmentManager().mo26a(this.mBackStackId);
                this.mBackStackId = -1;
                return;
            }
            ak a = getFragmentManager().mo24a();
            a.mo54a(this);
            if (z) {
                a.mo56b();
            } else {
    ...
    public LayoutInflater getLayoutInflater(Bundle bundle) {
        ...
        if (this.mDialog == null) {
            return (LayoutInflater) this.mHost.f301b.getSystemService("layout_inflater");
        }
    ...
    public int show(ak akVar, String str) {
        this.mDismissed = false;
        this.mShownByMe = true;
        akVar.mo55a(this, str);
        this.mViewDestroyed = false;
        this.mBackStackId = akVar.mo52a();
        return this.mBackStackId;
    }

    public void show(C0013z c0013z, String str) {
        this.mDismissed = false;
        this.mShownByMe = true;
        ak a = c0013z.mo24a();
        a.mo55a(this, str);
